...
<div>
	<span class="place-right"> <a class="button" href="#" onclick="openWindow('?module=masters&action=improvement_add')"> Add </a> </span>
	...
	<?php foreach($improvements as $id=>$R) { ?>
		<tr>
			<td nowrap style="width:120px">
				<a href="#" onclick="openWindow('?module=masters&action=improvement_edit&id=<?=$R['id']?>')" <?=displayHint('Edit')?> ><span class="mif-pencil"></a>
			</td>
